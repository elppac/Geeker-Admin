...
import { LifeCycleTypes, type FormPathPattern, type GeneralField, type DataField, type IFieldState } from "../types";
...
function createFieldEffect<Result extends GeneralField = GeneralField>(type: LifeCycleTypes) {
  return createEffectHook(
    type,
    (field: Result, page: Page) => (pattern: FormPathPattern, callback: (field: Result, page: Page) => void) => {
...
export function onFieldInit(pattern: FormPathPattern, callback?: (field: GeneralField, page: Page) => void) {
...
export function onFieldReact(pattern: FormPathPattern, callback?: (field: GeneralField, page: Page) => void) {
...
export function onFieldChange(pattern: FormPathPattern, callback?: (field: GeneralField, page: Page) => void): void;
